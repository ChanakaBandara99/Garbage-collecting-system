...
<button class="GFG" 
    onclick="window.location.href = 'http://localhost/demo/student-add.php';">
        Click Here To Upload Image
    </button>
    <button class="GFG" 
    onclick="window.location.href = 'http://localhost/demo/index.php';">
        Click Here To View Upload Image
    </button>

    <button class="GFG" 
    onclick="window.location.href = 'http://localhost/demo/new/article-upload.php';">
        Click Here To  Upload Article

    <button class="GFG" 
    onclick="window.location.href = 'http://localhost/demo/new/index1.php';">
        Click Here To View Upload Article
    </button>

<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3961.575840369662!2d80.0389979749103!3d6.821329093176435!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae2523b05555555%3A0x546c34cd99f6f488!2sNSBM%20Green%20University!5e0!3m2!1sen!2slk!4v1683733506607!5m2!1sen!2slk" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
